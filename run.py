...
if __name__ == "__main__":
    ...
    while True:
        algorithm = input("Enter the federated learning algorithm (fedavg, fedprox, scaffold, fedsparse, adaptopk, fedzip): ").strip().lower()
        if algorithm in ['fedavg', 'fedprox', 'scaffold', 'fedsparse', 'adaptopk', 'fedzip']:
            break
        print("Invalid input! Please enter 'fedavg', 'fedprox', 'scaffold', 'fedsparse', 'fedzip' ,or 'adaptopk'.")
